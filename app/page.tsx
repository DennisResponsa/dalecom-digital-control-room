...
export default function Home(){
  ...
  return <main>
    ...
    <section className="workspace"><nav className="stepper">{steps.map((x,i)=><div key={x} className={i===step?'active':i<step?'done':''}><b>{i<step?'✓':i+1}</b><span>{x}</span></div>)}</nav><div className="panel">
