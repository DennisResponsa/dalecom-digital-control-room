...
const tools = [
  ...
  {
    number: "09",
    eyebrow: "CENTRALE TECNICA",
    title: "Magazzino, officina e manutenzione",
    description: "Preparazione cantieri, mezzi, ricambi, lavaggi e uomini coordinati in un unico calendario.",
    action: "Apri la centrale tecnica",
    href: "/officina",
    accent: "yellow",
    disabled: false,
  },
  {
    ...
    description: "Automazioni descritte a parole per trasferte, promemoria, ricorrenze e coordinamento operativo.",
    action: "Apri le automazioni",
    href: "/ottimizzazione",
    accent: "red",
    disabled: false,
  },
  ...
  },
  {
    ...
    description: "Ricerca automatica, opportunità per Dalecom e clienti, fascicoli e lead economici per l’ufficio acquisti.",
    action: "Apri bandi e gare",
    href: "/bandi",
    accent: "violet",
    disabled: false,
  },
